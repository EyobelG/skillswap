...
<head>
  ...
  <title>SkillSwap – Contact Us</title>
...
<main class="container">
  ...
  <!-- everything that was inside <body> stays exactly here -->
  <!-- forms, headings, text, cards, etc -->
    <!-- Main Content -->
    <div class="container">
      <div class="contact-wrapper">
        ...
        <div class="contact-info">
          <h3 class="section-title">Other Ways to Reach Us</h3>
          ...
          <div class="info-grid">
            <div class="info-card">
              ...
              <div class="info-text">contact@skillswap.com</div>
            </div>
            ...
            <div class="info-card">
              ...
              <div class="info-text">Boston, MA, United States</div>
            </div>
          </div>
        </div>
      </div>
